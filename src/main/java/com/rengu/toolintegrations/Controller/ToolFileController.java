...
//    }
    ...
    //根据id删除工具文件
    @ApiOperation("根据id删除工具文件")
    @DeleteMapping(value = "/{toolFileId}/deletedToolFile")
    public ResultEntity deletedToolFileById(@PathVariable(value = "toolFileId")String toolFileId) throws IOException{
        return ResultUtils.build(toolFileService.deleteToolFileById(toolFileId));
    }
